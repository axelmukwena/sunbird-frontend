    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-light text-gray-800 mb-4">Welcome to your digital sign-in sheet</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            A modern solution to track meeting attendance across your organization. 
            No more passing around paper sheets - create meetings, track attendance, 
            and analyze participation all in one place.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">Create Meeting</h3>
          ...
          <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">View Meetings</h3>
            <p className="text-gray-600 mb-4 text-sm">
              Access past and scheduled meetings with detailed attendance records.
            </p>
            <Link href="/meetings">
          ...
          <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">Attendance Stats</h3>
            <p className="text-gray-600 mb-4 text-sm">
        ...
        <div className="mt-16">
          <h2 className="text-xl font-medium text-gray-800 mb-6">Recent Activity</h2>
          <div className="bg-white shadow-sm rounded-lg overflow-hidden">
            <div className="p-4 border-b border-gray-100 flex justify-between items-center">
              <span className="text-sm font-medium text-gray-700">You haven&apos;t created any meetings yet</span>
              <Link href="/meetings/create">
